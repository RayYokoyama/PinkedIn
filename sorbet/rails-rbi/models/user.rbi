...
module User::GeneratedAttributeMethods
  ...
  def current_career; end

  sig { params(value: T.nilable(T.any(String, Symbol))).void }
  def current_career=(value); end
  ...
  sig { returns(T.nilable(String)) }
  def graduated_university; end

  sig { params(value: T.nilable(T.any(String, Symbol))).void }
  def graduated_university=(value); end
...
module User::GeneratedAssociationMethods
  sig { returns(T.nilable(::EnterpriseAccount)) }
  ...
  sig { params(value: T.nilable(::EnterpriseAccount)).void }
...
class User < ApplicationRecord
  ...
  sig { returns(T.nilable(String)) }
  def graduated_university_name; end

  sig { returns(T.nilable(String)) }
  def first_same_university_user_name; end
end
