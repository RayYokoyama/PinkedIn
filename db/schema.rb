...
ActiveRecord::Schema.define(version: 2019_12_27_083538) do
  ...
  create_table "offer_users", force: :cascade do |t|
    ...
    t.index ["offer_id"], name: "index_offer_users_on_offer_id"
    t.index ["user_id"], name: "index_offer_users_on_user_id"
  end
